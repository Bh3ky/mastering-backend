...
class TestCommentViewSet:
    ...
    def test_create(self, client, user, post):
        ...
        response = client.post(self.endpoint + str(post.public_id) + "/comment/", data, format="json")
    ...
    def test_update(self, client, user, post, comment):
        ...
        response = client.put(self.endpoint + str(post.public_id) + "/comment/" + str(comment.public_id) + "/", data, format="json")
